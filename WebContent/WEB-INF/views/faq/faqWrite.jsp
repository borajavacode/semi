...
<body>
	...
	<div style="width: 100%;height: 60px;background-color: transparent; margin-bottom: 30px">
	<div >질문작성</div>
	</div>
	<div class="container" style="background-color: #353535; padding-top: 15px;">
	...
	<fieldset>
		...
		<table class="table" style="width: 100%;">
			...
			<tr class="table-dark">
				...
				<td>${sessionScope.m.memberId } <input type="hidden" name="faqWriter" value="${sessionScope.m.memberId }"></td>
				<th>공개여부</th>
				<td>
					공개 <input type="radio" id="faqStatus" name="faqStatus" value="1" checked>
			...
			<tr>
				<th colspan="4" style="text-align: center;">
					<button type="submit" class="btn btn-danger btn-block" style="width: 90%;background-color: #111111">질문하기</button>
				</th>
			</tr>
		</table>
	</fieldset>
